      ...
      <div className="container footer-flex">
        <div className="footer-main">
          ...
          <div className="footer-contact">
            ...
            <p><span role="img" aria-label="email">✉️</span> <a href="mailto:hello@getmorganizedtoday.com">hello@getmorganizedtoday.com</a></p>
            <p><span role="img" aria-label="location">📍</span> Greater New York City Area</p>
          </div>
          <div className="footer-social">
            <a href="https://www.instagram.com/get.morganized.today/" target="_blank" rel="noopener noreferrer" aria-label="Instagram">
            ...
            <a href="https://www.linkedin.com/company/get-morganized" target="_blank" rel="noopener noreferrer" aria-label="LinkedIn">
              <svg width="20" height="20" viewBox="0 0 24 24" fill="currentColor">
